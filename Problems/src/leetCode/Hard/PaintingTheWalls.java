...
public class PaintingTheWalls {
    ...
    private long paintWallsHelper(int[] cost, int[] time,
                                  int index, int total, Long[][] memo) {
        ...
        long with = cost[index] +
                paintWallsHelper(cost,time,index+1,
                        total+time[index]+1,
                        memo);

        long without = paintWallsHelper(
                cost,
                time,
                index+1,
                total,memo);
