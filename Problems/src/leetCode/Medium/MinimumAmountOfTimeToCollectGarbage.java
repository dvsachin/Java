 ...
 * Initialize variables hasG, hasP, and hasM to track if there is Glass, Paper, and Metal garbage in the city.
 ...
 *
 * Complexity
 * Time complexity: The time complexity is O(n), where n is the number of houses, as the solution iterates through the houses to calculate the total time.
