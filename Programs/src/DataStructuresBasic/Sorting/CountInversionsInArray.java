...
// TC = Naive = Theta(n^2) & SC = O(1)
// TC = Efficient = O(n * log n) & SC = O(n)
...
public class CountInversionsInArray {
    public static void main (String[] args)
    {
        ...
        int n = arr.length;
        System.out.print(countInversionNaive(arr,n));
        System.out.println();
        System.out.print(countInversionEfficient(arr,0,n-1));

    }

    static int countInversionNaive(int arr[], int n) {
